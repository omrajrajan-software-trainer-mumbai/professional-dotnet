// Program to demonstrate how group join works in C# with Visual Studio
// Programmer: Kavya Krishnan
namespace LINQGroupJoin_01
{
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("Program to demonstrate how group join works in C# with Visual Studio\n");
