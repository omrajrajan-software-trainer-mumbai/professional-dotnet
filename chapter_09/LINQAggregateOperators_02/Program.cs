// Program to demonstrate the use of Aggregete Operators that return a single value in C# with Visual Studio
// Programmer: Kavya Krishnan
namespace LINQAggregateOperators_02
{
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("Program to demonstrate the use of Aggregete Operators that return a single value in C# with Visual Studio\n");
