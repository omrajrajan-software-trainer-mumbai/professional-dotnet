// Program to demonstrate the use of Partitioning methods for easy paging in C# with Visual Studio
// Programmer: Kavya Krishnan

namespace LINQPartitioning_01
{
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("Program to demonstrate the use of Partitioning methods for easy paging in C# with Visual Studio\n");
