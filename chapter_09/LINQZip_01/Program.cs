// Program to demonstrate the use of Zip method to merge two related sequences in C# with Visual Studio
// Programmer: Kavya Krishnan

namespace LINQZip_01
{
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("Program to demonstrate the use of Zip method to merge two related sequences in C# with Visual Studio\n");
