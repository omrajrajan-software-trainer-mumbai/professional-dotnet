// Program to demonstrate the use of set operators in C# with Visual Studio
// Programmer: Kavya Krishnan

namespace LINQSetOperators_01
{
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("Program to demonstrate the use of set operators in C# with Visual Studio\n");
