// Program to demonstrate how left outer join works in C# with Visual Studio
// Programmer: Kavya Krishnan

namespace LINQLeftOuterJoin_01
{
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("Program to demonstrate how left outer join works in C# with Visual Studio\n");
