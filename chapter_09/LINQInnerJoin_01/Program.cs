// Program to demonstrate how inner join works in C# with Visual Studio
// Programmer: Kavya Krishnan

namespace LINQInnerJoin_01
{
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("Program to demonstrate how inner join works in C# with Visual Studio\n");
